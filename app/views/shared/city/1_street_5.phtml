<? $this->view->partial('shared/city_header', Array('title' => 'Промышленная Улица')); ?>
<div class="textblock">
	<table class='ltable'>
		<tr>
			<td style="vertical-align: top">
				...
				<ul class="mapHints">
					...
					<li><a href='<?=$this->url->get('map/') ?>?room=200'>Шахта</a>
					<li><a href='<?=$this->url->get('map/') ?>?room=666'>Тюрьма</a>
				</ul>
			</td>
			<td>
				<div style="position:relative;width: 550px;">
					...
					<div style="position:absolute; left:340px; top:108px; width:130px; height:105px;">
						<a href="<?=$this->url->get('map/') ?>?room=666"><img src="/images/world/city/<?= $city ?>/3_Prison.gif" data-content="Тюрьма" class="tooltip text aFilter"></a>
					</div>
					<div style="position:absolute; left:72px; top:191px; width:24px; height:23px;">
						<a href="<?=$this->url->get('map/') ?>?room=104"><img src="/images/world/city/<?= $city ?>/3_Left.gif" data-content="Парк" class="tooltip text aFilter"></a>
					</div>
					...
					<div style="position:absolute; left:247px; top:135px; width:30px; height:26px;">
						<a href="<?=$this->url->get('map/') ?>?room=200"><img src="/images/world/city/<?= $city ?>/3_Mine.gif" data-content="Шахта" class="tooltip text aFilter"></a>
					</div>
				</div>
			</td>
		</tr>
