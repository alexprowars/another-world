			...
			<tr>
				<td valign="top" class="textBlock">
					...
					<?
						...
						if ($otdel == 21)
							include(APP_PATH.'app/includes/library/works.php');
						elseif ($otdel == 22)
							include(APP_PATH.'app/includes/library/academy.php');
						elseif ($otdel == 23)
							include(APP_PATH.'app/includes/library/mf.php');
						else
							include(APP_PATH.'app/includes/library/_otdels.php');
