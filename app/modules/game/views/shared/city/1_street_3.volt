<? $this->view->partial('shared/city_header', Array('title' => 'Парк')); ?>
<div class="textblock">
	<table class='ltable'>
		<tr>
			<td style="vertical-align: top">
				...
				<ul class="mapHints">
					<li><a href='<?=$this->url->get('map/') ?>?room=103'>Торговая площадь</a>
					<li><a href='<?=$this->url->get('map/') ?>?room=10'>Башня магов</a>
					<li><a href='<?=$this->url->get('map/') ?>?room=16'>Центр занятости</a>
					<li><a href='<?=$this->url->get('map/') ?>?room=13'>Сувениры</a>
					<li><a href='<?=$this->url->get('map/') ?>?room=105'>Промышленная зона</a>
				</ul>
			</td>
			<td>
				<div style="position:relative;width: 550px;">
					...
					<div style="position:absolute; left:246px; top:174px; width:91px; height:69px;">
						<a href="<?=$this->url->get('map/') ?>?room=16"><img src="/images/world/city/<?= $city ?>/2_Gift.gif" data-content="Центр занятости" class="tooltip text aFilter"></a>
					</div>
					<div style="position:absolute; left:348px; top:204px; width:71px; height:49px;">
						<a href='<?=$this->url->get('map/') ?>?room=13'><img src="/images/world/city/<?= $city ?>/2_Loto.gif" data-content="Сувениры" class="tooltip text aFilter"></a>
					</div>
					...
					<div style="position:absolute; left:7px; top:230px; width:25px; height:24px;">
						<a href="<?=$this->url->get('map/') ?>?room=103"><img src="/images/world/city/<?= $city ?>/2_Left.gif" data-content="Торговая площадь" class="tooltip text aFilter"></a>
					</div>
					<div style="position:absolute; left:502px; top:265px; width:29px; height:26px;">
						<a href="<?=$this->url->get('map/') ?>?room=105"><img src="/images/world/city/<?= $city ?>/2_Right.gif" data-content="Промышленная зона" class="tooltip text aFilter"></a>
					</div>
					...
					<div style="position:absolute; left:283px; top:20px; width:32px; height:101px;">
						<a href="<?=$this->url->get('map/') ?>?room=10"><img src="/images/world/city/<?= $city ?>/2_Mage.gif" data-content="Башня Магов" class="tooltip text aFilter"></a>
					</div>
				</div>
			</td>
		</tr>
