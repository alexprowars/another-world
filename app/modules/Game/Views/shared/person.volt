...
<td width="200" valign="top" style="padding:0 10px;">
	<table class="parameters" style="width:100%;border:solid #e1d0b0 1.5pt;" bgcolor=efdcb8>
		...
		{% for code, name in _text('game', 'stats') %}
			<tr>
		...
		{% if isEdit %}
			...
			<tr>
				...
				<td align="right">
					<nobr>
						<small>{{ (parse['strength'] / 3 + parse['min'])|round ~ " - " ~ (1 + parse['strength'] / 1.5 + parse['max'])|round }}</small>
					</nobr>
				</td>
			</tr>
			<tr>
				...
				<td align="right">
					<nobr>
						<small>{{ (parse['razum'] / 1.5)|round ~ " - " ~ (1 + parse['razum'])|round }}</small>
					</nobr>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">
					<nobr>
						<small>
							<b title="Броня головы">{{ parse['br1'] }}</b>/
							<b title="Броня груди">{{ parse['br2'] }}</b>/
							<b title="Броня живота">{{ parse['br3'] }}</b>/
							<b title="Броня пояса">{{ parse['br4'] }}</b>/
							<b title="Броня ног">{{ parse['br5'] }}</b>/
						</small>
					</nobr>
				</td>
			</tr>
