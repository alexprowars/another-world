...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo">
			<a href="/admin/"><img src="/assets/admin/layout/img/logo.png" alt="logo" class="logo-default"/></a>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<? foreach ($menu as $item): ?>
					<li class="start <?=(($this->router->getActionName() == $item['alias']) ? 'active' : '') ?> ">
						<a href="/admin/<?= $item['alias'] ?>/">
							<i class="fa fa-<?=isset($item['icon']) ? $item['icon'] : '' ?>"></i>
							<span class="title"><?=$item['name'] ?></span>
							<? if ($this->router->getActionName() == $item['alias']): ?>
