...
/**
 * @method static ShopItems[]|Model\ResultsetInterface find(mixed $parameters = null)
 * @method static ShopItems findFirst(mixed $parameters = null)
 */
class ShopItems extends Model
{
	...
	{
		$this->belongsTo("shop_id", 'Game\Models\Shop', "id", Array('alias' => 'shop'));
		$this->belongsTo("item_id", 'Game\Models\Items', "id", Array('alias' => 'item'));
	}
