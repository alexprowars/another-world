...
if (isset($_GET['buy'])) {
                ...
                $buyitem_res = mysql_query("SELECT * FROM `items` WHERE `craft`=2 AND `name` = '".addslashes($_GET['buy'])."'");
...
if ($done == 0){$msg="У вас не хватает компонентов для создания предмета <u>".$buyitem['title']."</u>";}
			...
			if ($done == 1) {
							...
							$inf = "".$buyitem['name']."|".$buyitem['title']."|".$buyitem['price']."|0|".$secondary."|".$buyitem['art']."|0|".$buyitem['iznos']."";
                                                ...
                                                $result2 = mysql_query("INSERT INTO `objects` (`user`,`inf`,`min`,`tip`,`br1`,`br2`,`br3`,`br4`,`br5`,`min_d`,`max_d`,`hp`,`energy`,`strength`,`dex`,`agility`,`vitality`,`razum`,`krit`,`unkrit`,`uv`,`unuv`,`time`, `otravl`, `use_mana`, `magic`) VALUES ('".$stat['user']."','".$inf."','".$min."','".$buyitem['tip']."','".$buyitem['br1']."','".$buyitem['br2']."','".$buyitem['br3']."','".$buyitem['br4']."','".$buyitem['br5']."','".$buyitem['min']."','".$buyitem['max']."','".$buyitem['hp']."','".$buyitem['energy']."','".$buyitem['strength']."','".$buyitem['dex']."','".$buyitem['agility']."','".$buyitem['vitality']."','".$buyitem['razum']."','".$buyitem['krit']."','".$buyitem['unkrit']."','".$buyitem['uv']."','".$buyitem['unuv']."','".time()."','".$buyitem['otravl']."','".$buyitem['use_mana']."','".$buyitem['magic']."')");
