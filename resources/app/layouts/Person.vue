				...
				<td width="200" valign="top" style="padding:0 10px;">
					<table class="parameters" style="width:100%;border:solid #e1d0b0 1.5pt;" bgcolor=efdcb8>
						...
						<tr>
							...
							<td class="tc_b" align="right">{{ user.level }} [{{ user.level_up.up || 0 }}]</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="tc_b" align="right" width="70%" :title="'Осталось ' + (user.level_up.exp || 0) - user.experience + ' очков опыта'">
								{{ user.level_up.exp || 0 }}
							</td>
						</tr>
						<tr>
						...
						<tr v-for="stat in ['strength', 'dex', 'agility', 'vitality', 'power', 'razum', 'battery']">
							<td class="tc_dbl">{{ stat }}</td>
							<td align="right">
