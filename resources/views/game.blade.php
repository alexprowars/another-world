	...
	<div class="frame">
		...
		<div class="content">
			<div class="top">
				...
				<iframe src="{{ route('person.detail') }}" class="mainFrame" name="main" id="main" width="100%" height="100%"></iframe>
			</div>
			<div class="bottom">
				...
				<div class="buttons">
					<table width="100%">
						<tr>
							...
							@endif
							@if(($user->rank >= 10 && $user->rank < 15) || $user->rank >=98)
								<td><img src="/images/frames/lbd3.jpg" width="11" height="39" alt=""></td>
								<td>
